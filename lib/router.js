...
Router.route('/device', {name: 'devicePage'});
Router.route('/device_info', {name: 'deviceInfoPage'});
...
Router.route('/stat_service', {name: 'statServicePage'});
...
Router.route('/devices_products', {name: 'devicesProductsPage'});
